...
usage() {
	echo "Usage: $pgm [-h] [template1] [template2] ... [template n]"
	echo "    Supported templates:"
	echo "        baseos:\t\tFreeBSD-13.0-RELEASE"
	echo "        router:\t\tFreeBSD-13.0-RELEASE-router"
	echo "        firewall:\tFreeBSD-13.0-RELEASE-firewall (pf based)"
	echo "        router-frr7:\tFreeBSD-13.0-RELEASE-router-frr7"
	echo "        firewall-frr7:\tFreeBSD-13.0-RELEASE-firewall-frr7"
	echo "        firewall-frr7-access:\tFreeBSD-13.0-RELEASE-firewall-frr7-access"
	echo "        firewall-frr7-dial:\tFreeBSD-13.0-RELEASE-firewall-frr7-dial"
	echo "        host-freeradius3:\tFreeBSD-13.0-RELEASE-freeradius3"
	echo "        host-isc-dhcp44-server:\tFreeBSD-13.0-RELEASE-isc-dhcp44-server"
	echo "        host-unbound:\tFreeBSD-13.0-RELEASE-unbound"
}
